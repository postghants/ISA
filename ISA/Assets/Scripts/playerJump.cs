...
public class playerJump : MonoBehaviour
{
    ...
    [SerializeField] InputMap inputMap;
    ...
    private void calculateGravity()
    {
        ...
        body.velocity = new Vector3(velocity.x, Mathf.Clamp(velocity.y, -speedLimit, 100), velocity.z);
    }
    ...
    public void bounceUp(float bounceAmount)
    {
        ...
        body.AddForce(Vector3.up * bounceAmount, ForceMode.Impulse);
    }
}
